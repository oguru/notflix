...
const modalCardStyles = makeStyles((theme) => ({
   ...
   modalCard: {
      ...
      left: (props) => `${props.halfClientWidth - props.minModalWidth / 2}px`,
      overflow: "scroll",
      ...
      [theme.breakpoints.up("sm")]: {
         ...
         left: (props) => `${props.halfClientWidth - props.minModalWidth * 0.625}px`,
         top: (props) => `calc(50vh - ${props.minModalHeight * 0.625}px)`,
         width: (props) => `${props.minModalWidth * 1.25}px`
      },
      [theme.breakpoints.up("md")]: {
         height: (props) => `${props.minModalHeight}px`,
         left: (props) => `${props.halfClientWidth - props.minModalWidth * 1.125}px`,
         overflow: "visible",
